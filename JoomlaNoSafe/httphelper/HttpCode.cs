 ...
 * 07-12/2014
 * 
 * 使用HttpCode时,请先引用 System.Web 与 System.Web.Extensions( Framework 2.0不需要 )
 * 
 * 
 * .Net Framework : 2.0  请自行注释或删除 标记有 无效 字样的方法及命名空间
 *  
...
namespace HttpCodeLib
{
    partial class HttpRequest
    {
        ...
        /// 默认异步超时时间
        /// </summary>
        public const int DefaultTimeOutSpan = 3 * 1000;
        /// <summary>
        /// 请求结果类
        /// </summary>
